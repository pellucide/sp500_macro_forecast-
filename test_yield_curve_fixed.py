...
print("="*70)
print(f"YIELD CURVE PREDICTION TEST - SCALE={PREDICTION_SCALE}")
print("="*70)
...
# =============================================================================
print("\n" + "="*70)
print("STEP 1: FETCH YIELD CURVE DATA")
print("="*70)
...
# =============================================================================
# STEP 3: WALK-FORWARD OOS TEST (FIXED - PROPER TEMPORAL ALIGNMENT)
# =============================================================================
print("\n" + "="*70)
print("STEP 3: WALK-FORWARD OOS TEST (PROPER ALIGNMENT)")
print("="*70)
...
# =============================================================================
# STEP 4: CALCULATE METRICS (FIXED - CONSISTENT ALIGNMENT)
# =============================================================================
print("\n" + "="*70)
print("STEP 4: CALCULATE METRICS (FIXED ALIGNMENT)")
print("="*70)

def calc_metrics(preds, actual):
    """Calculate trading metrics with CONSISTENT alignment"""
